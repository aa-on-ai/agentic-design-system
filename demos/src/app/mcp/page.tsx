    ...
    <main className={styles.page} id="top" data-mcp-lab>
      ...
      >
        <div className={styles.heroCopy}>
          ...
          <p className={styles.heroLede}>
            Three tools let a coding agent render the interface, check the
            evidence, and prove why consequential decisions exist. The default
            stays model-free. Add explicit adapters when the work needs visual
            judgment or native Apple interface evidence.
          </p>
          <div className={styles.heroActions}>
            <a
              className={`${styles.action} ${styles.primaryAction} focus-ring`}
              href="#run"
            >
              Follow a real run
            </a>
            <a
              className={`${styles.action} ${styles.secondaryAction} focus-ring`}
              href="/mcp/contract.json"
            >
        ...
        <aside className={styles.sequenceTicket} aria-label="MCP server tools">
          ...
          <ol>
            {MCP_CONTRACT.tools.map((tool) => (
              <li key={tool.name}>
                ...
                <div>
                  <code>{tool.name}</code>
                  <small>{tool.verb} the work</small>
                </div>
          ...
          <p>
            <Terminal size={15} aria-hidden="true" /> npx ads-mcp@0.3.0 --root
            /your/project
          </p>
        </aside>
      </section>
      ...
      <article>
        <section className={styles.boundaryStrip} aria-label="MCP boundaries">
          ...
          <div>
            <span>Tools</span>
            <strong>Exactly 3</strong>
          </div>
          <div>
            <span>Render targets</span>
            <strong>Web + native Apple</strong>
          </div>
          <div>
            <span>Visual verdict</span>
        ...
        <section className={styles.toolsSection} aria-labelledby="tools-title">
          <div className={styles.sectionIntro}>
            ...
            <p>
              Each tool does one job and returns typed output plus read-only{" "}
              <code>ads://</code>
              resources. There is no generic shell tool hiding behind the
              protocol.
            </p>
          </div>
        ...
        >
          <div className={`${styles.sectionIntro} ${styles.inverse}`}>
            <div>
              ...
              <h2 id="run-title">
                One client. One run.
                <br />
                <em>Receipts all the way down.</em>
              </h2>
            </div>
            <p>
              This packet is generated through the compiled standard-input
              server and a real Model Context Protocol client. It is a local
              verification artifact, not a simulated dashboard feed.
            </p>
          </div>
          ...
          <aside className={styles.humanGate}>
            ...
            <div>
              <strong>
                <code>needs_human</code> is a feature.
              </strong>
              <p>
                Accessibility, overflow, state coverage, touch targets, and
                layout shift can clear mechanically. The default stops here for
                human review. A startup-configured judge can return typed
                scores, findings, and revision prompts only when a call
                explicitly opts in.
              </p>
            </div>
          </aside>
        ...
        >
          <div>
            ...
            <p>
              Large artifacts remain outside the chat transcript. Agents can
              fetch only the known files recorded for a run; the server never
              becomes a general filesystem browser.
            </p>
          </div>
          <ul>
        ...
        <section className={styles.close} aria-labelledby="close-title">
          ...
          <h2 id="close-title">
            ...
            <br />
            <em>Judgment does not disappear.</em>
          </h2>
