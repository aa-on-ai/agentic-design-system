      ...
      <section className="loop-section loop-section--evidence">
        <div className="loop-inner">
          ...
          <p className="loop-desc">
            ...
            builder never signs off on its own work.
          </p>
          <pre className="loop-snippet loop-snippet--big loop-snippet--terminal">
            ...
            <span className="loop-snippet-line">  FAIL  12 axe · 102 touch targets &lt;44px   → needs_revision</span>
            <span className="loop-snippet-line loop-snippet-line--cmd">iter2  revise → re-capture → gate</span>
            <span className="loop-snippet-line loop-snippet-line--pass">  axe 12 → 0   ·   overflow clean</span>
            <span className="loop-snippet-line">  FAIL  68 touch targets still &lt;44px        → failed</span>
            <span className="loop-snippet-line"> </span>
            <span className="loop-snippet-line loop-snippet-line--field">verdict: failed &mdash; the grader refused to ship a screen that still misses a hard gate</span>
          </pre>
          <p className="loop-desc">
            That &ldquo;no&rdquo; is the point. Because the gate reads rendered evidence, it can&rsquo;t
            be satisfied by a comment that says <code>{"// handles loading, empty, error"}</code>. It
            fixes what it can and refuses what it can&rsquo;t &mdash; the difference between &ldquo;my
            agent got better&rdquo; and a receipt you can audit.
          </p>
          <p className="loop-foot-line">
