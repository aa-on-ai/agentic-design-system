  ...
  return (
    ...
    >
      ...
      <div className="machine-bay">
        ...
        <div className="machine-footer" aria-hidden="true"><span>System / {number}</span><i /><span>Run 4821</span></div>
      </div>
    </section>
  );
}
...
const stations: StationProps[] = [
  { number: "01", id: "station-intent", eyebrow: "Clarify / outcome.md", title: "Turn the request into a testable outcome.", description: "The system gives the agent a job it can fail: who the screen is for, what must become obvious, which states are required, and when the run stops.", proofLabel: "Input", proof: "A concrete brief the agent can build against.", note: "It names the user, the outcome, the required states, and the stop condition.", stage: "intent", side: "left", lamp: "brief locked", machineLabel: "Outcome brief" },
  { number: "02", id: "station-baseline", eyebrow: "Build / first render", title: "Catch the failure in the pixels.", description: "The first build runs in a browser. The system records overflow, missing states, touch targets, and accessibility before taste enters the room.", proofLabel: "Failed check", proof: "Two visible failures tied to the rendered screen.", note: "The first capture found 36 pixels of overflow and a missing error state.", stage: "baseline", side: "right", lamp: "2 checks failed", lampTone: "red", machineLabel: "Browser capture" },
  { number: "03", id: "station-rubric", eyebrow: "Build / repair candidate", title: "Repair the screen, not the explanation.", description: "The coding agent changes the actual interface: delayed orders lead, recovery states exist, and the mobile layout no longer overflows.", proofLabel: "Corrected screen", proof: "The product changes where the evidence said it failed.", note: "Urgent work leads, missing states are complete, and mobile no longer overflows.", stage: "rubric", side: "left", lamp: "candidate ready", machineLabel: "Repair candidate" },
  { number: "04", id: "station-evidence", eyebrow: "Prove / run-report.md", title: "Package what changed and prove it.", description: "The system captures consistent viewports and attaches accessibility, overflow, and touch receipts so a reviewer can inspect the same result.", proofLabel: "Evidence report", proof: "Screenshots and checks travel with the change.", note: "The packet covers 390, 768, and 1280 pixel views with accessibility, overflow, and touch checks.", stage: "evidence", side: "right", lamp: "evidence complete", lampTone: "green", machineLabel: "Evidence report" },
  { number: "05", id: "station-release", eyebrow: "Review / grader-report.md", title: "A separate critic bounds the next decision.", description: "The grader accepts the evidence or returns a bounded revision. If the loop exhausts its budget, the unresolved judgment goes to a human.", proofLabel: "Grader verdict", proof: "Satisfied or needs revision, from a separate context.", note: "The critique stays independent. The human still accepts, revises, or stops.", stage: "release", side: "left", lamp: "satisfied", lampTone: "green", machineLabel: "Review verdict" },
];
