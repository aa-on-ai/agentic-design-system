...
| Accessibility | pass/fail | pass | pass | Evidence reports axe available with zero serious/critical violations, main landmarks and required live regions present, no sub-48px targets, no overflow, and CLS 0 in all snapshots. |
