...
| Accessibility | pass/fail | pass | pass | `evidence.json` reports zero serious/critical axe violations, present main and required live regions, and no touch targets under 48px. |
