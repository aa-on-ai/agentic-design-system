...
> Candidate rerun note, 2026-07-26: the v0.2.1 MCP repair updates shared capture behavior to
> support `playwright-core` without changing this frozen artifact. The artifact was freshly
> recaptured from behavior digest `9b5928bd`; all 8 rendered gates passed and all 8 screenshots
> compare pixel-identical to the prior passing run.
