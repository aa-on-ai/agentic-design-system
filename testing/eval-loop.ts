...
// HEURISTIC ONLY — this greps source for Tailwind breakpoint classes. It does NOT prove
// the layout works at any viewport. The original eval-spec promised "viewport screenshots"
// but this grep is all that ever shipped. Real responsive/overflow evidence now comes from
// skills/design-review/scripts/capture.mjs against a rendered preview; wiring the generated
// variants through a mount harness + capture is the documented next step (see testing/README.md).
async function detectResponsiveClasses(filePath: string) {
